    ...
    public static Algorithm createAlg(String algName, int populationSize, int numGenerations, Problem problem) throws ConfigurationException, JMException, FileNotFoundException {
        ...
        switch (algName) {
            ...
            case "NSGAII":
                ...
                return new NSGAII(problem, nsgaii.getMaxIteractions() * nsgaii.getPopulationSize(), nsgaii.getPopulationSize(), ab.generateCross(pmxswap), ab.generateMuta(pmxswap, nsgaii.getMaxIteractions()), ab.generateSelection(), new CrowdingDistanceComparator(), new SequentialSolutionListEvaluator());
            case "SPEA2":
                ...
                return new SPEA2(problem, numGenerations, populationSize, ab.generateCross(pmxswap), ab.generateMuta(pmxswap, spea2.getMaxIteractions()), ab.generateSelection(), new SequentialSolutionListEvaluator<>());
            case "PAES":
